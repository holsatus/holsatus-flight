...
impl super::Payload for RcChannelsPacked {}
impl super::AnyPayload for RcChannelsPacked {
    const LEN: usize = 22;

    fn packet_type(&self) -> super::super::packet_type::PacketType {
        super::super::packet_type::PacketType::RcChannelsPacked
    }
